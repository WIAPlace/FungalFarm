...
namespace HSM {
    public abstract class State {
        ...
        internal void Enter() {                             // top to bottom sequence
        ...
        internal void Exit() {
            if (ActiveChild != null) ActiveChild.Exit();    // bottom to top sequence
            ActiveChild = null;
            OnExit();
        }
        internal void Update(float deltaTime) {             // bottom to top sequence
